...
lift_type lift_create(void)
{
    ...
    pthread_cond_init(&lift->passenger_CV, NULL); ////////////////////////////////////////////////////////////////
    pthread_cond_init(&lift->lift_CV, NULL); ////////////////////////////////////////////////////////////////
    for (i = 0; i < N_FLOORS; ++i) ////////////////////////////////////////////////////////////////
    {
        pthread_cond_init(&lift->floor_CVs[i], NULL); ////////////////////////////////////////////////////////////////
    }
...
static int passengers_to_enter_lift(lift_type lift)
{
    ...
    int person_found = 0;
    int i;
    for (i=0; i < MAX_N_PERSONS && !person_found; i++)
    {
...
static int passengers_to_exit_lift(lift_type lift)
{
    ...
    int person_found = 0;
    int i;
    for (i = 0; i < MAX_N_PASSENGERS && !person_found; i++)
    {
...
void lift_has_arrived(lift_type lift, int floor) ////////////////////////////////////////////////////////////////////////////
{
    ...
    // signal to the passengers that the lift has arrived at the next floor:
    pthread_cond_broadcast(&lift->passenger_CV); ////////////////////////////////////////////////////////////////////////

    // wait for all passengers to leave the lift:
    while(passengers_to_exit_lift(lift))
    {
        pthread_cond_wait(&lift->lift_CV, &lift->mutex); //////////////////////////////////////////////////////
    }

    // signal to the persons standing at the next floor that the lift has arrived:
    pthread_cond_broadcast(&lift->floor_CVs[floor]); ////////////////////////////////////////////////////////////////////////

    // wait for all persons to enter the lift:
    while(passengers_to_enter_lift(lift) && possible_to_enter_lift(lift))
    {
        pthread_cond_wait(&lift->lift_CV, &lift->mutex); //////////////////////////////////////////////////////
    }
...
void lift_travel(lift_type lift, int id, int from_floor, int to_floor) //////////////////////////////////////////////////////////////
{
    ...
    //pthread_cond_broadcast(&lift->lift_CV); /////////////////////////////////////////////////////////////////////////////////////////

    draw_lift(lift);

    while(passenger_wait_for_lift(lift, from_floor))
    {
        pthread_cond_wait(&lift->floor_CVs[from_floor], &lift->mutex); ///////////////////////////////////////////////////////////////
    }
    ...
    {
        pthread_cond_wait(&lift->passenger_CV, &lift->mutex); ////////////////////////////////////////////////////////////////////
    }
