...
void enter_floor(lift_type lift, int id, int floor, int to_floor)
{
    ...
    lift->persons_to_enter[floor][person_index].id = id;
    lift->persons_to_enter[floor][person_index].to_floor = to_floor;
}
...
void leave_floor(lift_type lift, int floor, int *id, int *to_floor)
{
    ...
    lift->persons_to_enter[floor][person_index].to_floor = NO_FLOOR;
}
